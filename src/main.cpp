...
{
    // Insert Shaders here ...
    // For now, you use a string for your shader code, later on, shaders will be stored in .glsl files
...
int main(int argc, char *argv[])
{
    ...
    GLFWwindow *window = glfwCreateWindow(800, 600, "Triangle Template", NULL, NULL);
    if (window == NULL)
    {
